...
public class GetScheduleService {
    ...
    @Autowired
    public GetScheduleService(TrainingRepository trainingRepository, TrainerRepository trainerRepository, RegisterRepository registerRepository, UserRepository userRepository, LocationRepository locationRepository) {
    ...
    public List<GetTrainingRsp> getSchedule(String username) {
      ...
      List<Training> trainings = trainingRepository.findAllByTrainerIdAndTrainingDateStartAfter(trainer.getId(), date);
